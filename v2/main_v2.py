    ...
    with open(output_file, encoding= "utf-8",mode='w+') as out:
        ...
        for i, data in enumerate(tqdm(total_data)):
            ...
            if error_type:
                ...
                error_impressions, error_labels = error(output, df, cluster_info, K, ori_impression)
            ...
            if not error_type:
                ...
                for impression, label in zip(error_impressions, error_labels):
...
def main():
    ...
    parser.add_argument("--cluster", default="/home/kaeunkim/noise_medical_text/dataset/KMeans100_128k_f+i.pickle", type=str, help="path to cluster pickle file")
